...
- [ ] **Apply to Carbon Ads and/or Ethical Ads** as parallel revenue track — no approval wait, dev audience targeting. Do this now, don't wait for AdSense.
...
- [ ] **Publish 25 more guides** — currently at 35 (2026-05-18), target 60+. Prioritize: tutorials ("How to do X with Y"), comparisons, "X for developers" angles. Higher word count average (2000+) beats more 900-word guides.
